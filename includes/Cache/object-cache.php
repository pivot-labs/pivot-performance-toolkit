<?php
/**
 * Performance Toolkit - File-Based Object Cache Drop-in
 * Generated by: WP Performance Toolkit
 *
 * DO NOT EDIT - this file is managed by the Performance Toolkit plugin.
 *
...
if ( ! class_exists( 'WP_Object_Cache' ) ) {
	...
	class WP_Object_Cache {
		...
		public function stats(): void {
			...
			echo '<p>' . esc_html( sprintf( __( 'Cache hits: %d', 'performance-toolkit' ), $this->cache_hits ) ) . '<br />';
			/* translators: %d: number of cache misses. */
			echo esc_html( sprintf( __( 'Cache misses: %d', 'performance-toolkit' ), $this->cache_misses ) ) . '</p>';
		}
