 ...
 * @method \PerformanceToolkit\Vendor\Illuminate\Support\Carbon|null create($year = 0, $month = 1, $day = 1, $hour = 0, $minute = 0, $second = 0, $timezone = null)
 * @method \PerformanceToolkit\Vendor\Illuminate\Support\Carbon createFromDate($year = null, $month = null, $day = null, $timezone = null)
 * @method \PerformanceToolkit\Vendor\Illuminate\Support\Carbon|null createFromFormat($format, $time, $timezone = null)
 * @method \PerformanceToolkit\Vendor\Illuminate\Support\Carbon|null createFromIsoFormat(string $format, string $time, $timezone = null, ?string $locale = 'en', ?\PerformanceToolkit\Vendor\Symfony\Contracts\Translation\TranslatorInterface $translator = null)
 * @method \PerformanceToolkit\Vendor\Illuminate\Support\Carbon|null createFromLocaleFormat(string $format, string $locale, string $time, $timezone = null)
 * @method \PerformanceToolkit\Vendor\Illuminate\Support\Carbon|null createFromLocaleIsoFormat(string $format, string $locale, string $time, $timezone = null)
 * @method \PerformanceToolkit\Vendor\Illuminate\Support\Carbon createFromTime($hour = 0, $minute = 0, $second = 0, $timezone = null)
 * @method \PerformanceToolkit\Vendor\Illuminate\Support\Carbon createFromTimeString(string $time, \DateTimeZone|string|int|null $timezone = null)
 * @method \PerformanceToolkit\Vendor\Illuminate\Support\Carbon createFromTimestamp(string|int|float $timestamp, \DateTimeZone|string|int|null $timezone = null)
 * @method \PerformanceToolkit\Vendor\Illuminate\Support\Carbon createFromTimestampMs(string|int|float $timestamp, \DateTimeZone|string|int|null $timezone = null)
 * @method \PerformanceToolkit\Vendor\Illuminate\Support\Carbon createFromTimestampMsUTC($timestamp)
 * @method \PerformanceToolkit\Vendor\Illuminate\Support\Carbon createFromTimestampUTC(string|int|float $timestamp)
 * @method \PerformanceToolkit\Vendor\Illuminate\Support\Carbon createMidnightDate($year = null, $month = null, $day = null, $timezone = null)
 * @method \PerformanceToolkit\Vendor\Illuminate\Support\Carbon|null createSafe($year = null, $month = null, $day = null, $hour = null, $minute = null, $second = null, $timezone = null)
 * @method \PerformanceToolkit\Vendor\Illuminate\Support\Carbon createStrict(?int $year = 0, ?int $month = 1, ?int $day = 1, ?int $hour = 0, ?int $minute = 0, ?int $second = 0, $timezone = null)
 ...
 * @method \PerformanceToolkit\Vendor\Symfony\Contracts\Translation\TranslatorInterface getTranslator()
 ...
 * @method \PerformanceToolkit\Vendor\Illuminate\Support\Carbon instance(\DateTimeInterface $date)
 ...
 * @method \PerformanceToolkit\Vendor\Illuminate\Support\Carbon|null make($var, \DateTimeZone|string|null $timezone = null)
 * @method void mixin(object|string $mixin)
 * @method \PerformanceToolkit\Vendor\Illuminate\Support\Carbon now(\DateTimeZone|string|int|null $timezone = null)
 * @method \PerformanceToolkit\Vendor\Illuminate\Support\Carbon parse(\DateTimeInterface|\PerformanceToolkit\Vendor\Carbon\WeekDay|\PerformanceToolkit\Vendor\Carbon\Month|string|int|float|null $time, \DateTimeZone|string|int|null $timezone = null)
 * @method \PerformanceToolkit\Vendor\Illuminate\Support\Carbon parseFromLocale(string $time, ?string $locale = null, \DateTimeZone|string|int|null $timezone = null)
 * @method string pluralUnit(string $unit)
 * @method \PerformanceToolkit\Vendor\Illuminate\Support\Carbon|null rawCreateFromFormat(string $format, string $time, $timezone = null)
 * @method \PerformanceToolkit\Vendor\Illuminate\Support\Carbon rawParse(\DateTimeInterface|\PerformanceToolkit\Vendor\Carbon\WeekDay|\PerformanceToolkit\Vendor\Carbon\Month|string|int|float|null $time, \DateTimeZone|string|int|null $timezone = null)
 ...
 * @method void setTranslator(\PerformanceToolkit\Vendor\Symfony\Contracts\Translation\TranslatorInterface $translator)
 ...
 * @method \PerformanceToolkit\Vendor\Illuminate\Support\Carbon today(\DateTimeZone|string|int|null $timezone = null)
 * @method \PerformanceToolkit\Vendor\Illuminate\Support\Carbon tomorrow(\DateTimeZone|string|int|null $timezone = null)
 * @method string translateTimeString(string $timeString, ?string $from = null, ?string $to = null, int $mode = \PerformanceToolkit\Vendor\Carbon\CarbonInterface::TRANSLATE_ALL)
 * @method string translateWith(\PerformanceToolkit\Vendor\Symfony\Contracts\Translation\TranslatorInterface $translator, string $key, array $parameters = [], $number = null)
 ...
 * @method \PerformanceToolkit\Vendor\Illuminate\Support\Carbon yesterday(\DateTimeZone|string|int|null $timezone = null)
 */
class DateFactory
{
    /**
