...
class ViewErrorBag implements Countable, Stringable
{
     ...
     *
     * @var array<string, \PivotPerformanceToolkit\Vendor\Illuminate\Contracts\Support\MessageBag>
     */
    protected $bags = [];
     ...
     * Get all the bags.
     *
     * @return array<string, \PivotPerformanceToolkit\Vendor\Illuminate\Contracts\Support\MessageBag>
     */
