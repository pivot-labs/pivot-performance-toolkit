...
class ViewErrorBag implements Countable, Stringable
{
     ...
     *
     * @var array<string, \PerformanceToolkit\Vendor\Illuminate\Contracts\Support\MessageBag>
     */
    protected $bags = [];
     ...
     * Get all the bags.
     *
     * @return array<string, \PerformanceToolkit\Vendor\Illuminate\Contracts\Support\MessageBag>
     */
