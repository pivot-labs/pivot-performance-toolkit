 ...
 * @method static \Illuminate\Http\Client\Factory allowStrayRequests(array<int, string>|null $only = null)
 ...
 * @method static void assertSentInOrder(array<string|\Closure|callable> $callbacks)
