 ...
 * @method static \PerformanceToolkit\Vendor\Illuminate\Support\Uri uri()
 ...
 * @method static \PerformanceToolkit\Vendor\Illuminate\Contracts\Session\Session session()
 * @method static void setLaravelSession(\PerformanceToolkit\Vendor\Illuminate\Contracts\Session\Session $session)
 ...
 * @method static \PerformanceToolkit\Vendor\Illuminate\Support\Fluent fluent(array|string|null $key = null, array $default = [])
 ...
 * @method static \PerformanceToolkit\Vendor\Illuminate\Support\Stringable str(string $key, mixed $default = null)
 * @method static \PerformanceToolkit\Vendor\Illuminate\Support\Stringable string(string $key, mixed $default = null)
 ...
 * @method static \PerformanceToolkit\Vendor\Illuminate\Support\Carbon|null date(string $key, string|null $format = null, \UnitEnum|string|null $tz = null)
 * @method static \PerformanceToolkit\Vendor\Carbon\CarbonInterval|null interval(string $key, \PerformanceToolkit\Vendor\Carbon\Unit|string|null $unit = null)
 ...
 * @method static \PerformanceToolkit\Vendor\Illuminate\Support\Collection collect(array|string|null $key = null)
