 ...
 * @method static \PivotPerformanceToolkit\Vendor\Illuminate\Support\Uri uri()
 ...
 * @method static \PivotPerformanceToolkit\Vendor\Illuminate\Contracts\Session\Session session()
 * @method static void setLaravelSession(\PivotPerformanceToolkit\Vendor\Illuminate\Contracts\Session\Session $session)
 ...
 * @method static \PivotPerformanceToolkit\Vendor\Illuminate\Support\Fluent fluent(array|string|null $key = null, array $default = [])
 ...
 * @method static array<string, \Illuminate\Http\UploadedFile|\Illuminate\Http\UploadedFile[]> allFiles()
 * @method static bool hasFile(string $key)
 * @method static array<string, \Illuminate\Http\UploadedFile|\Illuminate\Http\UploadedFile[]>|\Illuminate\Http\UploadedFile|\Illuminate\Http\UploadedFile[]|null file(string|null $key = null, mixed $default = null)
 ...
 * @method static \PivotPerformanceToolkit\Vendor\Illuminate\Support\Stringable str(string $key, mixed $default = null)
 * @method static \PivotPerformanceToolkit\Vendor\Illuminate\Support\Stringable string(string $key, mixed $default = null)
 ...
 * @method static \PivotPerformanceToolkit\Vendor\Illuminate\Support\Carbon|null date(string $key, string|null $format = null, \UnitEnum|string|null $tz = null)
 * @method static \PivotPerformanceToolkit\Vendor\Carbon\CarbonInterval|null interval(string $key, \PivotPerformanceToolkit\Vendor\Carbon\Unit|string|null $unit = null)
 * @method static \BackedEnum|(\BackedEnum|null enum(string $key, string<\BackedEnum> $enumClass, \BackedEnum|null $default = null)
 * @method static \BackedEnum[] enums(string $key, string<\BackedEnum> $enumClass)
 * @method static array array(array|string|null $key = null)
 * @method static \PivotPerformanceToolkit\Vendor\Illuminate\Support\Collection collect(array|string|null $key = null)
