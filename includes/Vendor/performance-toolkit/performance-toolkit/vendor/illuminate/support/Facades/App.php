 ...
 * @method static object|mixed make(string|string<object> $abstract, array $parameters = [])
 ...
 * @method static \Closure|\Closure factory(string|string<object> $abstract)
 * @method static object|mixed makeWith(string|string<object>|callable $abstract, array $parameters = [])
 * @method static object|mixed get(string|string<object> $id)
 * @method static object build(\Closure|string<object> $concrete)
