...
use PivotPerformanceToolkit\Vendor\GuzzleHttp\Exception\BadResponseException;
use PivotPerformanceToolkit\Vendor\GuzzleHttp\Exception\TooManyRedirectsException;
...
class RedirectMiddleware
{
    ...
    public function checkRedirect(RequestInterface $request, array $options, ResponseInterface $response)
    {
        ...
        if (\PivotPerformanceToolkit\Vendor\GuzzleHttp\Psr7\UriComparator::isCrossOrigin($request->getUri(), $nextRequest->getUri()) && defined('\CURLOPT_HTTPAUTH')) {
    ...
    public function modifyRequest(RequestInterface $request, array $options, ResponseInterface $response): RequestInterface
    {
        ...
        $modify['uri'] = $uri;
        \PivotPerformanceToolkit\Vendor\GuzzleHttp\Psr7\Message::rewindBody($request);
        ...
        if (\PivotPerformanceToolkit\Vendor\GuzzleHttp\Psr7\UriComparator::isCrossOrigin($request->getUri(), $modify['uri'])) {
            $modify['remove_headers'][] = 'Authorization';
            $modify['remove_headers'][] = 'Cookie';
        }
        return \PivotPerformanceToolkit\Vendor\GuzzleHttp\Psr7\Utils::modifyRequest($request, $modify);
    }
    /**
    ...
    {
        $location = \PivotPerformanceToolkit\Vendor\GuzzleHttp\Psr7\UriResolver::resolve($request->getUri(), new Psr7\Uri($response->getHeaderLine('Location')));
