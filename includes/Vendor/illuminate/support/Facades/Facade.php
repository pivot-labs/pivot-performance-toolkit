...
abstract class Facade
{
    ...
    public static function spy()
    {
        if (! static::isMock()) {
            ...
            return performancetoolkit_vendor_tap($class ? Mockery::spy($class) : Mockery::spy(), function ($spy) {
                static::swap($spy);
            });
        }
    }
    ...
    {
        return performancetoolkit_vendor_tap(static::createMock(), function ($mock) {
            static::swap($mock);
