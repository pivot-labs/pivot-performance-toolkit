...
class Event extends Facade
{
    ...
    public static function fake($eventsToFake = [])
    {
        ...
        return pivotperformancetoolkit_vendor_tap(new EventFake($actualDispatcher, $eventsToFake), function ($fake) {
            static::swap($fake);
    ...
    public static function fakeFor(callable $callable, array $eventsToFake = [])
    {
        ...
        return pivotperformancetoolkit_vendor_tap($callable(), function () use ($originalDispatcher) {
