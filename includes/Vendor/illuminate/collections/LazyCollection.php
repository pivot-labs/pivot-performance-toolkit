...
class LazyCollection implements CanBeEscapedWhenCastToString, Enumerable
{
    ...
    {
        if (func_num_args() === 2) {
            return $this->contains(fn ($item) => performancetoolkit_vendor_data_get($item, $key) === $value);
        }
     ...
     *
     * @param  \PerformanceToolkit\Vendor\Illuminate\Contracts\Support\Arrayable<TCrossJoinKey, TCrossJoinValue>|iterable<TCrossJoinKey, TCrossJoinValue>  ...$arrays
     ...
     *
     * @param  \PerformanceToolkit\Vendor\Illuminate\Support\Enumerable<array-key, TKey>|array<array-key, TKey>  $keys
     * @return static
     */
    ...
    public function last(?callable $callback = null, $default = null)
    {
        ...
        return $needle === $placeholder ? performancetoolkit_vendor_value($default) : $needle;
    }
