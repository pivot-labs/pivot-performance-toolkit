...
<section class="ptk-card col-span-full w-full" id="ptk-performance-test-card" data-ptk-performance-test>
    <div data-ptk-section="title">
        <div class="flex flex-wrap items-start justify-between gap-3">
            ...
            <?php if ( ! empty( $showOpenFullTest ) ) : ?>
                <a class="button" href="<?php echo esc_url( add_query_arg( array( 'page' => 'performance-toolkit', 'section' => 'optimization', 'tab' => 'performance-toolkit-performance' ), admin_url( 'admin.php' ) ) ); ?>"><?php esc_html_e( 'Open Full Test', 'performance-toolkit' ); ?></a>
            <?php endif; ?>
        </div>
    </div>
            ...
            <div class="rounded-lg border border-gray-200 bg-white p-3">
                <div class="grid items-center gap-3 lg:grid-cols-[225px_minmax(0,1fr)]">
                    <div class="flex justify-center">
                        <x-score-donut :score="(int) $lastScore" size="225" data-ptk-score-donut />
                    </div>
