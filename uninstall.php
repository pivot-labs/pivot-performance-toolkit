...
// true PHP global (this file is `include`d at the top level during uninstall,
// so without this wrapper each variable would leak into the global variable
// table for the rest of the request).
( function () {
